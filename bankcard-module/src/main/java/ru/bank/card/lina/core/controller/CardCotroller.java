...
public class CardCotroller {
    ...
    @PostMapping("/save")
    public CardDTO saveCard(@RequestBody CardRequest card){
        return cardService.saveCard(card);
    }

    @GetMapping("/{id}")
    public CardDTO findById(@RequestParam Long card_id){
    ...
    public List<CardDTO> findAllUserCard(@RequestParam Long user_id){
        return cardService.findAllUserCard(user_id);
    }

    @PostMapping("/deposit")
    public CardDTO depositToCard(@RequestParam Long card_id, @RequestParam BigDecimal amount){
        return cardService.depositToCard(card_id, amount);
    }

    @PostMapping("/withdraw")
    public CardDTO withdrawFromCard(@RequestParam Long card_id, @RequestParam BigDecimal amount){
